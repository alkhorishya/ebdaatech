...
const ReviewTrueFalse = (props) => {
  ...
  const learnLanguageString = "English";
  ...
  const playAudio = () => {
    // setWord(questions[questionIndex].translation[learnLanguageString]);

    speechSynthesis.cancel(); // Cancel ongoing speech
    const utterance = new SpeechSynthesisUtterance(word);
    console.log("playword:",questions[questionIndex].translation[learnLanguageString]);
