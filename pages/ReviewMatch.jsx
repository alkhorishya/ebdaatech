...
const ReviewMatch = (props) => {
  ...
  const gameData = [
    [
      { id: 1, words: ["House", "منزل"], matched: false },
      { id: 2, words: ["City", "مدينة"], matched: false },
      { id: 3, words: ["School", "مدرسة"], matched: false },
      { id: 4, words: ["Brother", "اخ"], matched: false },
      { id: 5, words: ["Clothes", "ملابس"], matched: false },
      { id: 6, words: ["Sister", "اخت"], matched: false },
    ],
    [
