...
export default function Home(props) {
  const buttons = [
    ...
    { Icon: GraduationCapIcon, text: "مبتداء", route: "/Letters" },
    {
      Icon: CalendarCheckIcon,
      text: "كلمة اليوم",
      route: "/word-of-the-day",
    },
    { Icon: GraduationCapIcon, text: "تعلم", route: "/learn" },
    { Icon: CircleCheckIcon, text: "تحدي", route: "/review" },
    { Icon: ProgressIcon, text: "معالجه", route: "/progress" },
    { Icon: CogWheelIcon, text: "اعدادات", route: "/settings" },
